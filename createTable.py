...
def create_table():
    ...
    c.execute('create trigger if not exists calculate_sp_update after update on stock for each row begin update stock set sell_price = new.cost_price*1.18*1.2 where cycle_name = new.cycle_name; end')
